...
import static ma.disignMall.Models.user.Permission.ADMIN_CREATE;
import static ma.disignMall.Models.user.Permission.ADMIN_DELETE;
import static ma.disignMall.Models.user.Permission.ADMIN_READ;
import static ma.disignMall.Models.user.Permission.ADMIN_UPDATE;
import static ma.disignMall.Models.user.Permission.COMPANY_CREATE;
import static ma.disignMall.Models.user.Permission.COMPANY_DELETE;
import static ma.disignMall.Models.user.Permission.COMPANY_READ;
import static ma.disignMall.Models.user.Permission.COMPANY_UPDATE;
import static ma.disignMall.Models.user.Permission.APPLICANT_CREATE;
import static ma.disignMall.Models.user.Permission.APPLICANT_DELETE;
import static ma.disignMall.Models.user.Permission.APPLICANT_READ;
import static ma.disignMall.Models.user.Permission.APPLICANT_UPDATE;
import static ma.disignMall.Models.user.Role.ADMIN;
import static ma.disignMall.Models.user.Role.COMPANY;
import static ma.disignMall.Models.user.Role.APPLICANT;
